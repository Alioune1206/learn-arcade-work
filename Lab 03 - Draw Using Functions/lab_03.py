...
# Draw a Plane
arcade.draw_ellipse_filled(450, 700, 160, 40, arcade.csscolor.FLORAL_WHITE)
arcade.draw_circle_filled(400, 710, 10, arcade.csscolor.BLACK)
arcade.draw_ellipse_filled(450, 650, 50, 100, arcade.csscolor.FLORAL_WHITE)
arcade.draw_ellipse_filled(370, 700, 25, 25, arcade.csscolor.YELLOW)
